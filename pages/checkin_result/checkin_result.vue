	...
	<view class="page">
		...
		<view class="checkin-report">
			...
			<view class="calendar-container">
				<view class="calendar" v-for="one in weekCheckin">
...
<script>
	export default {
		data() {
			return {
				name:'',
			//	photo: 'https://thirdwx.qlogo.cn/mmopen/vi_32/DYAIOgq83erOibQT46XSkarhN5ca1fUia82BI6HjicYP2Blo80Oc3icdFmgQxuqXP5zvR1R1FAiaoJPreTB3uedQvQg/132',
				photo: '',
				deptName: "",
				address: "",
				status: "",
